...
function launchScanWindow() {
  ...
  exec('ssh kali@172.20.10.6 "/home/kali/scripts/launchScan.sh &> /dev/null"', (output) => {
    console.log(output);
    console.log("ssh'ed into payload, scan complete.");
    //progressBar.setCompleted();
    exec('scp kali@172.20.10.6:/home/kali/bigData-01.csv bigData-01.csv', (output) => {
        console.log(output);
        console.log("scan data copied to desktop");
        //command = 2;
        exec('ssh kali@172.20.10.6 "rm -f bigData-01.csv"', (output) => {
          console.log(output);
          console.log("scan data removed from pi");
          //progressBar.setCompleted();
